export const RECEIPT_EXTRACTION_PROMPT_LINES = [
  ...
  "items には itemName、printedAmountYen、amountBasis、taxRatePercent、taxMarker、categoryName、quantity、unitPriceYen、confidence、warnings を入れてください。",
